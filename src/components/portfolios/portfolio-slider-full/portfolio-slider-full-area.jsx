...
import portfolio_slider_data from "../portfolio-data/portfolio-slider-data";
...
const PortfolioSliderFullArea = ({style_gallery}) => {
  ...
  //  images
  const img = portfolio_slider_data.map((item) => item.img.src);

  return (
    <> 
      <div className={`portfolio-area ${style_gallery ? "pt-20" : "pt-120 pb-120"} portfolio-slider`}> 
                    <div className="container-fluid">  
                        <div className="row portfolio-slider-active arrow-style text-center slick-slider">                            
                            ...
                            <Slider {...setting} ref={sliderRef}>
                                {portfolio_slider_data.map((item, i) => 
...
export default PortfolioSliderFullArea;
