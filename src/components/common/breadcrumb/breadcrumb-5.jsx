...
const BreadcrumbFive = ({top_title= "Blog Details", title = "Blog Details"}) => {
    return (
        <>
            <div className="page-title-area pos-relative gray-bg  fix" style={{backgroundImage: `url(/assets/img/bg/page-title-bg-2.jpg)`}}>
